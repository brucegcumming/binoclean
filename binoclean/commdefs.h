...
#define ABS_ORTHOG_POS MAXSAVECODES+13  ////STIMULUS POS use RP for RF, RP=RP+x
#define ABS_PARA_POS MAXSAVECODES+14  //STIMULUS POS
...
#define SEND_VERG_ONLY 11 //Spike2 does't need to know, but verg does.
...
ValueCode valstrings[] = {
  ...
  {"sy",     "Sigma Y",  SD_Y, 1, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"dp",     "Diparate phase", DISP_P, 3, 'N' ,5, SEND_EXPT, SAVE_ALWAYS},
  {"dx",     "Disparity ", DISP_X, 3, 'N' ,5, SEND_EXPT, SAVE_ALWAYS},
  {"sz",     "Size (H and W)",STIM_SIZE, 1+INDIRECT , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"wi",     "Width ", STIM_WIDTH, 1, 'N' ,4, SEND_EXPT, SAVE_ALWAYS},
  {"hi",     "Height ", STIM_HEIGHT, 1, 'N' ,4, SEND_EXPT, SAVE_ALWAYS},
  {"sf",     "Spatial Frequency", SF,  1, 'N' ,4, SEND_EXPT, SAVE_ALWAYS},
  {"xn",     "X sampling", XSAMPLES, 1, 'N' ,0, SEND_EXPLICIT, SAVE_ALWAYS},
  {"yn",     "Y Sampling", YSAMPLES, 1, 'N' ,0, SEND_EXPLICIT, SAVE_ALWAYS},
  {"tf",     "Temporal Frequency", TF, 1, 'N' ,2, SEND_EXPT, SAVE_ALWAYS},
  {"ph",     "Spatial Phase",  SETPHASE, 1, 'N' ,2, SEND_EXPT, SAVE_ALWAYS},
  {"or",     "Orientation",  ORIENTATION, 1, 'N' ,1, SEND_EXPT, SAVE_ALWAYS},
  {"sl",     "Seed Loop", SET_SEEDLOOP, 5, 'N' ,0, SEND_EXPT, SAVE_ALWAYS},
  {"se",     "Seed", SET_SEED, 5, 'N' ,0, SEND_STIMULUS, SAVE_ALWAYS},
  {"co",     "Contrast ", SETCONTRAST, 1, 'N' ,4, SEND_EXPLICIT, SAVE_ALWAYS},
  {"dy",     "Vertical Disparity", DISP_Y, 3, 'N' ,4, SEND_EXPT, SAVE_ALWAYS},
  {"f2",     "SF2", SF2, 1+COMPOUND_GRATING, 'N' ,2, SEND_GRATING2, SAVE_ALWAYS},
  {"t2",     "TF2", TF2, 1+COMPOUND_GRATING, 'N' ,2, SEND_GRATING2, SAVE_ALWAYS},
  {"p2",     "Phase2", PHASE2, 1+COMPOUND_GRATING, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"a2",     "Plaid angle", PLAID_ANGLE, 1+COMPOUND_GRATING, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
    {"v2",   "Velocity2",VELOCITY2, 5,'N', 2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"jv",     "J velocity", JVELOCITY, 5, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"bpos",     "Boundary Position", BPOSITION, 5, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"bjv",     "Boundary velocity", BVELOCITY, 5, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"fi",     "front intensity",JF_INTENSITY, 5, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"bi",     "back intensity", JB_INTENSITY, 5, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"jn",     "cyl num dots", JNUMDOTS, 5, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"jl",     "dotlife (cyl)",JLIFEFRAMES, 5, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS}, 
  {"jx",     "death chance",  JDEATH, 5, 'N' ,4, SEND_EXPT, SAVE_ALWAYS},
  {"nbars",     "Nnumber of Bars", NBARS, 5, 'N' ,0, SEND_EXPLICIT, SAVE_ALWAYS},
  {"c2",     "contrast 2", CONTRAST2, 1, 'N' ,4, SEND_EXPLICIT, SAVE_ALWAYS},
  {"ic",     "Delta contrast (L-R)", CONTRAST_DIFF, 3, 'N' ,4, SEND_EXPLICIT, SAVE_ALWAYS},
  {"od",     "Delta ori (L-R)", ORIENTATION_DIFF, 3, 'N' ,2, SEND_EXPT_NONZERO, SAVE_ALWAYS},
  {"ds",     "Delta SF (L-R)", SF_DIFF, 3, 'N' ,4, SEND_EXPLICIT, SAVE_ALWAYS},
  {"dg",     "disp grad", DISP_GRAD, 3, 'N' ,4, SEND_EXPLICIT, SAVE_ALWAYS},
  {"dm",     "depth modulation", DEPTH_MOD, 3, 'N' ,4, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"ta",     "twobar angle", TWOBAR_ANGSEP, 1, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
// {"dr",     "Disp Ramp", DISP_RAMP, 3, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"dq",     "pDisp 2", PHASE2DISP, 3, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"rp",     "Rel Phase",  PHASEREL, 3, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Pd",     "Phase Disp as Disp", PHASE_AS_DISP, 3, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"ce",     "Correlation", CORRELATION, 3, 'N' ,4, SEND_STIMULUS, SAVE_ALWAYS},
  {"dw",     "Dot Width", DOT_SIZE, 5, 'N' ,4, SEND_EXPLICIT, SAVE_ALWAYS},
  {"fc",     "Fixation Color", SETFIXCOLOR, 8, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"zx",     "Zoom",  SETZOOM, 32, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"bc",     "BackGround Color ", SETBACKCOLOR, 32, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"dt",     "Delay", DELAY, 32 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"pr",     "PREPERIOD", PREPERIOD_CODE, 16, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS}, 
  {"et",     "Expt1 Type",  EXPTYPE_CODE, 16 , 'C' ,2, SEND_EXPT, SAVE_ALWAYS},
  {"fz",     "FRAMERATE",  FRAMERATE_CODE, 32 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"du",     "Stimulus Duration", STIMULUS_DURATION_CODE, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"vc",     "CLAMP_DISPARITY", CLAMP_DISPARITY_CODE, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"po",     "POSTPERIOD", POSTPERIOD_CODE, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"mo",     "Mode",MODE_CODE, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
//  {"vr",     "RAMP_VERGENCE",RAMP_VERGENCE_CODE, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"nt",     "N Stim (Expt 1)",NTRIALS_CODE, 32 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"uf",     "Uff Prefix",UFF_PREFIX, 32 , 'C' ,2, SEND_USER_ONLY, SAVE_ALWAYS},
  {"hx",     "High X Value for Interleaves",HIGHX, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"sM",     "Stimulus mode",STIMULUS_MODE, 1 , 'N' ,2, SEND_EXPT, SAVE_ALWAYS},
  {"wr",     "WURTZ task response period", WURTZ_RT_CODE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"mD",     "Max Signal for Near-zero manip", INITIAL_APPLY_MAX, 17 , 'N' ,5, SEND_EXPT, SAVE_ALWAYS},
  {"op",     "optionflag setup", OPTION_CODE, 16 , 'N' ,2, SEND_STIMULUS, SAVE_ALWAYS},
  {"nr",     "N Repetitions", NREPS_CODE, 16 , 'N' ,2, SEND_EXPT, SAVE_ALWAYS},
//  {"tl",     "trigger level", TRIGGER_LEVEL, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"fw",     "fixation window", FIXATION_WINDOW, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"df",     "display flag",DISPLAYFLAG_CODE, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
...
//  {"wf",     "mean fixation period",WURTZ_DURATION_CODE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  ...
  {"is",     "ISI", ISI_CODE, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"it",     "InterTrial Min Duration", INTERTRIAL_MIN, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"bw",     "bin width", UNIT_BINWIDTH, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"ub",     "binned unit data",BINNED_SPIKE_DATA, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
// {"ut",     "unit times",SPIKE_TIMES, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"nf",     "N Frames",NFRAMES_CODE, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"bd",     "backgound disparity", DISP_BACK, 64 , 'N' ,4, SEND_EXPT, SAVE_ALWAYS},
//  {"rk",     "ramp coefficient", RAMP_COEFFICIENT, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"fx",     "fixation x pos ",FIXPOS_X, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"fy",     "fixation y pos ",FIXPOS_Y, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"fs",     "fixation size ",SETFIXSIZE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"cj",     "mean conjugate",STATIC_CONJUGATE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"rw",     "Reward Size", REWARD_SIZE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"vh",     "Vergence RAMP and Hold", RAMP_HOLD_CODE, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"ti",     "Timeout",  TIMEOUT_CODE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"so",     "Software Offsets",SOFTOFF_CODE, 32 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"qs",     "Query State", QUERY_STATE, 128 , 'N' ,2, SEND_READ_ONLY, SAVE_NEVER},
  {"sb",     "Stop Button", STOP_BUTTON, 1024 , 'N' ,2, SEND_READ_ONLY, SAVE_NEVER},
//  {"ra",     "Ramp Amplitude", RAMP_AMPLITUDE_CODE, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"lb",     "Initial Blank Period", TRIAL_START_BLANK, 16 , 'N' ,2, SEND_EXPT, SAVE_ALWAYS},
//  {"ul",     "UpLoad Directory*", UPLOAD_CODE, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"vw",     "Vergence Window",VERGENCE_WINDOW, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"sp",     "Short Prem Trial Length",SHORT_PREM_CODE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"ed",     "electrode depth", ELECTRODE_DEPTH, 32 | EXPT_NOT_ALLOWED, 'N' ,2, SEND_USER_ONLY, SAVE_ALWAYS},
  {"cm",     "Comment", UFF_COMMENT, 128 , 'C' ,2, SEND_USER_ONLY, SAVE_NEVER},
  {"ss",     "Seed Shift/UC gap", SEED_SHIFT, 7 , 'N' ,0, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"cp",     "Conjugate Position",CONJUGATE_POSITION, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"pd",     "Deg2pix", DEG2PIX, 32 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"yx",     "DRAGGED_POS",DRAGGED_POS, 1024 , 'N' ,2, SEND_READ_ONLY, SAVE_NEVER},
  {"o2",     "optionflag2",STIMULUS_OPTIONS, 32 , 'N' ,2, SEND_READ_ONLY, SAVE_NEVER},
  {"sq",     "H Saccade Size",SACCADE_VALUE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"to",     "WRONG_TIMEOUT",WRONG_TIMEOUT_CODE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"s0",     "STARTVAL", STARTVAL, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"sh",     "MAXSTAIRVAL",MAXSTAIRVAL, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"sm",     "MINSTAIRVAL",MINSTAIRVAL, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"js",     "STANDING_DISP",STANDING_DISP, 1 , 'N' ,4, SEND_EXPT, SAVE_ALWAYS},
  {"jc",     "Saccade Box size",SAC_FIX_CRIT, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"jt",     "Choice Target  Size",SACTARGSIZE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"vs",     "V Saccade Size",VSACCADE_VALUE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"dd",     "Dot Density", DOT_DENSITY, 3, 'N' ,2, SEND_EXPT, SAVE_ALWAYS},
  {"Vs",     "VSR",VSR, 1 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"cl",     "SEND_CLEAR",SEND_CLEAR, 128 , 'N' ,0, SEND_READ_ONLY, SAVE_NEVER},
  {"e2",     "Expt 2 Type",EXPTYPE_CODE2, 16 , 'C' ,0, SEND_EXPT, SAVE_ALWAYS},
  {"m2",     "Expt 2 Mean",EXPT2_MEAN, 16 , 'N' ,5, SEND_EXPT, SAVE_ALWAYS},
  {"e0",     "EXPTYPE_NONE",EXPTYPE_NONE, 16 , 'N' ,0, SEND_EXPLICIT, SAVE_ALWAYS}, //verg needs this for menus
  {"n2",     "Expt 2 Nstims",EXPT2_NSTIM, 16 , 'N' ,0, SEND_EXPT, SAVE_ALWAYS},
  {"i2",     "Expt 2 increment",EXPT2_INCR, 16 , 'N' ,5, SEND_EXPT, SAVE_ALWAYS},
  {"ac",     "ANTICORRELATED_DISPARITY",ANTICORRELATED_DISPARITY, 3+INDIRECT , 'N' ,4, SEND_EXPLICIT, SAVE_NEVER},
  {"cd",     "CORRELATED_DISPARITY",CORRELATED_DISPARITY, 3+INDIRECT, 'N' ,4, SEND_EXPLICIT, SAVE_NEVER},
  {"Dm",     "Distribution Mean",DISTRIBUTION_MEAN, 3 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"np",     "N Planes",NPLANES , 3 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"me",     "MONOCULARITY_EXPT",MONOCULARITY_EXPT, 128 , 'N' ,0, SEND_STIMULUS, SAVE_NEVER},
  {"cv",     "VERGENCE_CORRECTION",VERGENCE_CORRECTION, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"fh",     "FIXATION_SURROUND",FIXATION_SURROUND, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"bh",     "Back Size",BACK_SIZE, 64+INDIRECT , 'N' ,2, SEND_EXPT, SAVE_NEVER},
  {"fd",     "Fixation Overlap duration",FIXATION_OVERLAP, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"fr",     "P(reward)",PREWARD, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"aq",     "Acquision ON/OFF",ACQUISITION_CODE, 128 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"rd",     "Relative Disparity",RELDISP, 512+1 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"oL",     "ORI_LEFT",ORI_LEFT, 512+5 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"oR",     "ORI_RIGHT",ORI_RIGHT, 512+5 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"ve",     "Version",VERSION_CODE, 32 , 'C' ,2, SEND_EXPT, SAVE_ALWAYS},
  {"vve",     "Verg Version",VERGVERSION_CODE, 32 , 'C' ,2, SEND_EXPT, SAVE_ALWAYS},
  {"cb",     "Backround Correlation",BACK_CORRELATION, 64+INDIRECT, 'N' ,2 , SEND_EXPT, SAVE_NEVER},
  {"sd",     "Seed Delay",SEED_DELAY, 5 , 'N' ,0, SEND_EXPLICIT, SAVE_ALWAYS},
// {"xx",     "Trigger 1",TRIGGER_LEVEL1, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"xx",     "Trigger 2",TRIGGER_LEVEL2, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"xx",     "Trigger 3",TRIGGER_LEVEL3, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"xx",     "Trigger 4",TRIGGER_LEVEL4, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"cs",     "RC seed",RC_SEED, 32 , 'N' ,0, SEND_STIMULUS, SAVE_ALWAYS},
  {"fn",     "frame repeat",FRAMEREPEAT, 16 , 'N' ,0, SEND_EXPT, SAVE_ALWAYS},
  {"cx",     "Change type",STIMCHANGE_CODE, 128 , 'C' ,0, SEND_EXPLICIT, SAVE_ALWAYS},
  {"fp",     "NewFixPos",FIXPOS_XY , 8+INDIRECT , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"Ro",     "RF Ori",RF_ANGLE, 128 , 'N' ,2, SEND_EXPT, SAVE_ALWAYS},
  {"Bs",     "BackStim",BACKSTIM_TYPE, 64 , 'C' ,0, SEND_EXPT, SAVE_NEVER},
    {"St3",     "Stim3 Type",STIM3_TYPE, 64 , 'C' ,0, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Fs",     "FP Move Size",FP_MOVE_SIZE, 8 , 'N' ,4, SEND_NON_ZERO, SAVE_ALWAYS},
  {"Fa",     "FP Move Dir",FP_MOVE_DIR , 8 , 'N' ,2, SEND_EXPT, SAVE_ALWAYS},
  {"ip",     "Starting Phase",START_PHASE , 1 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  ...
  {"zf",     "Disparity of Fixpt",FIXPT_DISPARITY, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"rv",     "Relatve Vdisp",RELVDISP, 512+3 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"vm",     "Vdisp mod",VDISP_MOD, 3 , 'N' ,4, SEND_EXPLICIT, SAVE_ALWAYS},
  {"hd",     "Length Disparity",LENGTH_DISP, 3 , 'N' ,4, SEND_EXPLICIT, SAVE_ALWAYS},
  {"wd",     "Width Disparity",WIDTH_DISP, 3 , 'N' ,4, SEND_EXPLICIT, SAVE_ALWAYS},
  {"nc",     "N Components/Boundaries",NCOMPONENTS, 1 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"id",     "Stim ID",STIMID, 1 , 'N' ,0, SEND_STIMULUS, SAVE_ALWAYS},
  {"O2",     "Ori 2",ORI2, 1 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"n3",     "Nstim 3",EXPT3_NSTIM, 16 , 'N' ,0, SEND_EXPT, SAVE_ALWAYS},
  {"Sr",     "Spin Rate",SPINRATE, 1 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Bw",     "Back Width",BACK_WIDTH, 64 , 'N' ,4, SEND_EXPLICIT, SAVE_NEVER},
  {"Bh",     "Back Height",BACK_HEIGHT, 64 , 'N' ,4, SEND_EXPLICIT, SAVE_NEVER},
  {"xd",     "Dot X Pos",DOT_POSX, 1 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"ob",     "Orientation Bandwidth",ORI_BANDWIDTH, 1 , 'N' ,0, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Ri",     "Incr for FastSeq",RC1INC, 16 , 'N' ,4, SEND_EXPT, SAVE_ALWAYS},
  {"Dw",     "Distribution Width",DISTRIBUTION_WIDTH, 1 , 'N' ,2, SEND_EXPT, SAVE_ALWAYS},
  {"fH",     "Fixwin Height",FIXWIN_HEIGHT, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"i3",     "Incr 3",EXPT3_INCR, 16 , 'N' ,5, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Dc",     "Distribution Conc",DISTRIBUTION_CONC, 1 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"St",     "Saccade Threshold",SACCADE_THRESHOLD, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Sa",     "Saccade Detected",SACCADE_DETECTED, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Id",     "Initial Disparity",INITIAL_DISPARITY, 17 , 'N' ,4, SEND_EXPLICIT, SAVE_ALWAYS},
  {"vv",     "Vertical Vergence",VERTICAL_VERGENCE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  ...
  {"puA",     "Pursuit Amplitude",PURSUIT_AMPLITUDE, 8 , 'N' ,4, SEND_EXPT, SAVE_ALWAYS},
  {"puF",     "Pursuit Increment",PURSUIT_FREQUENCY, 8 , 'N' ,4, SEND_EXPT, SAVE_ALWAYS},
  {"USp",     "Microstim Phase Onset",MICROSTIM_PHASE_ONSET, 8 , 'N' ,4, SEND_EXPT, SAVE_ALWAYS},
   {"USd",     "Microstim Phase Duration",MICROSTIM_PHASE_DURATION, 8 , 'N' ,4, SEND_EXPT, SAVE_ALWAYS},
   {"USf",     "Periodic Microstim Frequncy",MICROSTIM_PERIODIC, 8 , 'N' ,4, SEND_EXPT, SAVE_ALWAYS},
  {"IB",     "Backgr Image",BACKGROUND_IMAGE, 0 , 'C' ,0 , SEND_EXPLICIT, SAVE_ALWAYS},
  {"Br",     "Fast Rpt B", FASTB_RPT, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"bz",     "Backgr Zoom",BACKGROUND_ZOOM, 32 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"rr",     "Rc repeats",RC_REPEATS, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"ap",     "AFC Proportion",AFC_PROPORTION, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Im",     "Initial Movement",INITIAL_MOVEMENT, 17 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"bO",     "Backgr Ortho pos",BACK_OPOS,512+64 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"bP",     "Backgr Para pos",BACK_PPOS, 512+64 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"rb",     "Reward Bias",REWARD_BIAS, 8 , 'N' ,2, SEND_EXPT, SAVE_ALWAYS},
  {"Tx",     "Target X off",TARGET_XOFFSET , 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Ty",     "Target Y off",TARGET_YOFFSET , 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"T2",     "Target 2 pos",TARGET2_POS , 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"mixac",     "AC Mixture",MIXAC, 1 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"ijump",     "Image Jumps",IMAGEJUMPS, 1 , 'N' ,0, SEND_EXPT, SAVE_ALWAYS},
    {"imx",     "Image X pos",IMAGEXPOS, 3 , 'N' ,0, SEND_EXPT, SAVE_ALWAYS},
    {"imy",     "Image Y pos",IMAGEYPOS, 3 , 'N' ,0, SEND_EXPT, SAVE_ALWAYS},
    
  {"Tt",     "Tone time",TONETIME, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"iD",  "Opposite Delay",OPPOSITE_DELAY , 1 , 'N' ,5, SEND_EXPLICIT, SAVE_ALWAYS},
    {"baddir",  "Saccade Punish Direcion",SACCADE_PUNISH_DIRECTION , 8 , 'N' ,1, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Fr", "FAST_SEQUENCE rpt",FAST_SEQUENCE_RPT, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"db", "Wurtz Brightness Shift,",BRIGHTSHIFT_CODE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"tc", "Timeout color",BLANKCOLOR_CODE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  ...
  {"eo", "END_OFFSET,",END_OFFSET, 512 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
 // {"xr", "XMINSAMPLE_RATIO",XMINSAMPLE_RATIO, 1 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
...
//  {"di", "DIRECTIONALIGY, +20 ",DIRECTION_TEXT, 128 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"ct", "CELL_TYPE, +21 ",CELLTYPE_TEXT , 128 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"fl", "Stimulus Flag",STIMULUS_FLAG , 1 , 'C' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"si", "swap interval +23 ",SWAPINTERVAL , 32 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"Tz", "Trapezoidal scaling for projectors ",TRAPEZOIDAL_SCALING , 32 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Rw", "RF Width",RF_WIDTH, 256 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Rh", "RF Height",RF_HEIGHT, 256 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
...
//  {"Py", "Plot Y",PLOTY, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"nT", "Trial Count",TRIAL_COUNT, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_STATE},
  ...
  {"pb", "p(Blank)", BLANK_P, 16, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"cc", "Covary Coefficient", COVARY_XPOS, 24, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"bl",     "BONUS_CRITERION", BONUS_CRITERION, 8, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"b2",     "BONUS2_CRITERION", BONUS2_CRITERION, 8, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"bs",     "EXPT_BLKSIZ", EXPT_BLKSIZ, 8, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS}, 
  {"cL",     "CONTRAST_LEFT", CONTRAST_LEFT, 512+3, 'N' ,4, SEND_EXPLICIT, SAVE_NEVER},
  {"cR",    "CONTRAST_RIGHT",CONTRAST_RIGHT, 512+3 , 'N' ,4, SEND_EXPLICIT, SAVE_NEVER},
//  {"tb",     "Twobar sep",TWOBAR_SEP, 1 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Fl",     "Fixation Linw",FIX_LINW, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"cg",     "SETCLEARCOLOR",SETCLEARCOLOR, 32 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"bj",     "BACKJUMP",BACKJUMP, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"lf",     "SF left",SF_LEFT, 512+3 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"rf",     "SF Right",SF_RIGHT, 512+3 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"rx",     "X randomization",RANDOM_X, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"ox",     "Ori randomization",RANDOM_ORI, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"bb",     "dOri F+B",DORI_BOTH , 3 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"dk",     "dOri Back",DORI_BACK , 66 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
 // {"xc",     "Stim eccentricity",STIM_ECCENTRICITY , 513 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
//  {"pa",     "Polar Angle",STIM_POLARANGLE , 513 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
//  {"o0",    "Old Lori",OLDLEFT_ORI, 514 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"o1",    "Old Rori",OLDRIGHT_ORI, 514 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"xx",     "Cyberamp channels",CYBER_CHANNELS, 128 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"rs",     "RF Sign",RF_SIGN, 256 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"el",     "End Length",END_LENGTH, 512 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"lw",     "Line Width for online plot",EXPT_LINW, 32 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"ps",     "Plot Smoothing for online RC",PLOTSMOOTH, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"pf",     "Flags Shown on panel",SHOWFLAGS_CODE, 128 , 'C' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"pt",     "Stimuli per fixation Trial",EXPT_STIMPERTRIAL, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"ri",     "RC Correlation delay",RC_DELAY, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"cr",     "Contrast Ratio",CONTRAST_RATIO, 3 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"tx",     "Expt 2 x or + ",ADDEXPTS_CODE , 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
// {"ci",     "Command in",COMMAND_IN, 128 , 'C' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"gr",     "Grid Size",GRIDSIZE, 32 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"dO",     "Orthog Disp",ORTHOG_DISP, 515 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"dP",     "Paralell Disp",PARALELL_DISP, 515 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
//  {"sr",     "RDS/Sine",RDSXSINE, 512 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"ns",     "Change Seed",CHANGE_SEED, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"d1",     "Disparity 1",DISP_A, 513 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"d2",     "Disparity 2",DISP_B, 513 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"Ff",     "FP Move Frame",FP_MOVE_FRAME, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"lX",     "Xpos (log)",XOFFLOG, 528 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"mx",     "L-R-Binoc",LRBINTERLEAVE, 528 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"LR",     "L-R-Monoc",LRINTERLEAVE, 528 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"LB",     "L-Binoc",LBINTERLEAVE, 528 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"RB",     "R-Binoc",RBINTERLEAVE, 528 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"lS",     "SF-Lin",SFLIN, 528 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"lT",     "TF-Lin",TFLIN, 528 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"oS",     "Log Size",LOG_SIZE, 528 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"m3",     "Expt 3 Mean",EXPT3_MEAN, 16 , 'N' ,2, SEND_EXPT, SAVE_ALWAYS},
  {"pU",     "p(Uncorr)",UNCORR_P , 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
    {"pS",  "p(Signal frame)", SIGNALFRAME_P, 16, 'N', 2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"pT",     "p(One Target)",ONETARGET_P, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"sO",     "StimOrthog Pos",STIMORTHOG_POS, 513 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"pR",     "Plaid Contrast Ratio",PLAID_RATIO, 1+INDIRECT , 'N' ,4, SEND_EXPLICIT, SAVE_NEVER},
  {"Al",     "Avg Len for eyepos auto-zero",AUTO_ZERO, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"xx",     "Old Orthog disp",OLD_ORTHOG_DISP, 512 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"xx",     "Old Paralell disp",OLD_PARA_DISP, 512 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  ...
  {"tr",     "Target Ratio",TARGET_RATIO, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"hs",     "High SF val",HIGHSF, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"ht",     "High TF val",HIGHTF, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"cz",     "Contrast Pairs",CONTRAST_PAIRS, 528 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
//  {"sL",     "Stepper Plot Length",STEPPER_PLOTLEN, 32 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Nf",     "True Nframes",NFRAMES_DONE, 32 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
 // {"pC",     "Plot Cluster/Exp No.",PLOT_CLUSTER, 32 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"r1",     "Reward 1",REWARD_SIZE1, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"r2",     "Reward 2",REWARD_SIZE2, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"r3",     "Reward 3",REWARD_SIZE3, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Tc",     "Timeout Contrast",TIMEOUT_CONTRAST, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"nR",     "RC File Counter",RCFILE_CTR, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"As",     "Alternative Stimulus",ALTERNATE_STIM_MODE, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Us",     "Microstim Expt",MICROSTIM_EXPT, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"T1",     "Test value 1",TEST_VALUE1, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"TB",    "Test value 2",TEST_VALUE2, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"Ba",    "Size to add for background",BACK_ADD_SIZE, 64 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"xx",    "RC stimulus change",RC_STIMCHANGE, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  ...
  {"wL",     "Width L",WIDTH_L, 515 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"wR",     "Width R",WIDTH_R, 515 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"SL",     "Size L",SIZE_L, 515 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"SR",     "Size R",SIZE_R, 515 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"Sd",     "Size Disparity",SIZE_DISP, 3, 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"fm",     "FixPt Ocularity",FIXPT_EYE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"Sb",     "Sigma X and Y",SD_BOTH, 513 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"uk",     "Uka Stair Coeffs",UKA_VALS, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"Pr",     "Phase Disp as RelDisp",PHASE_AS_RELDISP, 513 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
//  {"PX",     "Panel X position",PANEL_XPOS, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"rc",     "Relative contrast",FB_RELATIVE_CONTRAST, 513 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"by",     "Background Vertical Disp",BACK_VDISP, 64 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
//  {"PY",     "Panel Y position",PANEL_YPOS, 0 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"sC",     "Counterphase",SET_COUNTERPHASE, 1 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"ui",     "User id", USERID, 128 , 'C' ,2, SEND_EXPT, SAVE_ALWAYS},
  {"Tw",     "Time Ori BW",TEMPORAL_ORI_BANDWIDTH, 1 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"ts",     "Shake Timeout",SHAKE_TIMEOUT_DURATION, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"Ol",     "Orthog Pos L",ORTHOG_POSL, 515 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"Or",     "Orthog Pos R", ORTHOG_POSR, 515 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"Covariate",     "Covariate",COVARIATE, 16 , 'C' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"iF",     "Initial Frames (Duration)",INITIAL_DURATION, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"e1max",     "Expt1 Max",EXPT1_MAXSIG, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"dS",     "FakeStim Expt", FAKESTIM_EXPT, 16 , 'N' ,0, SEND_EXPLICIT, SAVE_NEVER},
  {"FakeSig",     "FakeStim Signal", FAKESTIM_SIGNAL, 16 , 'N' ,4, SEND_EXPLICIT, SAVE_ALWAYS},
  {"pBlack",     "p(black dot)", BLACKDOT_FRACTION, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"hxtype",     "High X type",HIGHXTYPE, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"monkey", "monkey name (Directory)",MONKEYNAME, 128 , 'C' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"ar", "Aspect Ratio", ASPECT_RATIO, 513 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
//  {"Hi", "Hidden Codes", HIDDEN_OPTIONS, 128 , 'C' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"nl",     "N Low F Components", NLOWCOMPONENTS, 1 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"nh",     "N High F Comonents", NHIGHCOMPONENTS, 1,  'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"ls",     "Final Seed",LAST_SEED, 1 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"dfx",    "fx change", FIXPOS_XSHIFT, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"ddx",    "dx change",NEWDISP, 513 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"backMov",    "Backgr Movie",BACKGROUND_MOVIE, 16 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"xL",    "Xpos Left",LEFTX, 512 , 'N' ,3, SEND_EXPLICIT, SAVE_NEVER},
    {"yL",    "Ypos Left",LEFTY, 512 , 'N' ,3, SEND_EXPLICIT, SAVE_NEVER},
    {"xR",    "Xpos Right",RIGHTX, 512 , 'N' ,3, SEND_EXPLICIT, SAVE_NEVER},
    {"yR",    "Ypos Right",RIGHTY, 512 , 'N' ,3, SEND_EXPLICIT, SAVE_NEVER},
  {"annTyp",     "Annulus Type",SETANNULUS, 1 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"StartDepth",     "Start Depth",PEN_START_DEPTH, 128 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  {"TwoCylDisp",     "TwoCyl Disp",TWOCYL_DISP, 513 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  {"rC",     "Random Contrasts",RANDOM_CONTRAST_EXPT, 528 , 'N' ,2, SEND_EXPLICIT, SAVE_NEVER},
  ...
  {"verbose", "Verbosity", VERBOSE_CODE, 128 , 'N' ,0, SEND_EXPLICIT, SAVE_STATE},
    ...
    {  "eZ", "Electrode Impedance", IMPEDANCE, 0, 'N', 0, SEND_EXPLICIT, SAVE_STATE},
    {  "ePr", "Guide Tube Protrusion", PROTRUSION, 0, 'N', 0, SEND_EXPLICIT, SAVE_STATE},
    {  "hemi", "HemiSphere", HEMISPHERE, 0, 'C', 0, SEND_EXPLICIT, SAVE_STATE},
...
#define REVERSING_DOTS (1<<(LASTRDSFLAG+16))

#define NUM_STIM_FLAGS (LASTRDSFLAG+17)
