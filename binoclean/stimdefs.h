...
#define MONITOR_STATE (LAST_CODED_OPTION+18)
#define CUSTOM_EXPVAL (LAST_CODED_OPTION+19)
#define TESTING_FRAMES (LAST_CODED_OPTION+20)

#define MAXALLFLAGS (LAST_CODED_OPTION+21)
...
#define LEFTRIGHT_SPACETIME_IMAGES 3
#define BINOCULAR_SPACETIME_IMAGES 4
#define MAXORBW 126
